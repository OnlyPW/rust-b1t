<div align="center">
  ...
  <img alt="Rust pepecoin logo by Hunter Trujillo, see license and source files under /logo" src="./logo/rust-bitcoin.png" width="300" />

  <p>Library with support for de/serialization, parsing and executing on data-structures
    and network messages related to pepecoin.
  </p>
...
* De/serialization of pepecoin protocol network messages
...
For JSONRPC interaction with pepecoin Core, it is recommended to use
...
this library and the pepecoin Core reference implementation. In a consensus
based cryptocurrency such as pepecoin it is critical that all parties are
...
Patches which add support for non-pepecoin cryptocurrencies by adding constants
