...
use nintondo_pepecoin::bip32::{ChildNumber, ExtendedPrivKey, ExtendedPubKey, KeySource};
use nintondo_pepecoin::blockdata::locktime::{absolute, relative};
use nintondo_pepecoin::blockdata::witness::Witness;
use nintondo_pepecoin::consensus::encode::deserialize;
use nintondo_pepecoin::hashes::hex::FromHex;
use nintondo_pepecoin::hashes::{hash160, ripemd160, sha256, sha256d, Hash};
use nintondo_pepecoin::psbt::raw::{self, Key, Pair, ProprietaryKey};
use nintondo_pepecoin::psbt::{Input, Output, Psbt, PsbtSighashType};
use nintondo_pepecoin::sighash::{EcdsaSighashType, TapSighashType};
use nintondo_pepecoin::taproot::{self, ControlBlock, LeafVersion, TapTree, TaprootBuilder};
use nintondo_pepecoin::{
...
fn serde_regression_address() {
    ...
    let addr = Address::p2pkh(&pk, Network::Pepecoin);
