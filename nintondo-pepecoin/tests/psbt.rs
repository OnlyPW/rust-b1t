...
use nintondo_pepecoin::bip32::{
    ExtendedPrivKey, ExtendedPubKey, Fingerprint, IntoDerivationPath, KeySource,
};
use nintondo_pepecoin::blockdata::opcodes::OP_0;
use nintondo_pepecoin::blockdata::script;
use nintondo_pepecoin::consensus::encode::{deserialize, serialize_hex};
use nintondo_pepecoin::hashes::hex::FromHex;
use nintondo_pepecoin::psbt::{Psbt, PsbtSighashType};
use nintondo_pepecoin::script::PushBytes;
use nintondo_pepecoin::secp256k1::{self, Secp256k1};
...
fn create_transaction() -> Transaction {
    ...
    Transaction {
        ...
        output: vec![
            TxOut {
                value: Amount::from_str_in(output_0.amount, Denomination::Pepecoin)
            ...
            TxOut {
                value: Amount::from_str_in(output_1.amount, Denomination::Pepecoin)
                    .expect("failed to parse amount")
                    .to_sat(),
...
fn signer_one_sign(
    psbt: Psbt,
    key_map: BTreeMap<nintondo_pepecoin::PublicKey, PrivateKey>,
) -> Psbt {
...
fn sign(mut psbt: Psbt, keys: BTreeMap<nintondo_pepecoin::PublicKey, PrivateKey>) -> Psbt {
    let secp = Secp256k1::new();
