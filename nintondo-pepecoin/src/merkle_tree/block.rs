...
//!
//! ```rust
//! use nintondo_pepecoin::hash_types::Txid;
//! use nintondo_pepecoin::hashes::hex::FromHex;
//! use nintondo_pepecoin::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = nintondo_pepecoin::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = nintondo_pepecoin::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use nintondo_pepecoin::hash_types::Txid;
    /// use nintondo_pepecoin::hashes::hex::FromHex;
    /// use nintondo_pepecoin::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
