...
mod test {
    ...
    fn serialize_verack_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::B1t), payload: NetworkMessage::Verack }),
    ...
    fn serialize_ping_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::B1t), payload: NetworkMessage::Ping(100) }),
    ...
    fn serialize_mempool_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::B1t), payload: NetworkMessage::MemPool }),
    ...
    fn serialize_getaddr_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::B1t), payload: NetworkMessage::GetAddr }),
    ...
    fn deserialize_version_test() {
        ...
        assert!(msg.is_ok());
        let msg = msg.unwrap();
        assert_eq!(msg.magic, Magic::from(Network::B1t));
