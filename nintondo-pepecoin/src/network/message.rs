...
mod test {
    ...
    fn serialize_verack_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::Pepecoin), payload: NetworkMessage::Verack }),
    ...
    fn serialize_ping_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::Pepecoin), payload: NetworkMessage::Ping(100) }),
    ...
    fn serialize_mempool_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::Pepecoin), payload: NetworkMessage::MemPool }),
    ...
    fn serialize_getaddr_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: Magic::from(Network::Pepecoin), payload: NetworkMessage::GetAddr }),
    ...
    fn deserialize_getaddr_test() {
        ...
        let preimage = RawNetworkMessage {
            magic: Magic::from(Network::Pepecoin),
    ...
    fn deserialize_version_test() {
        ...
        assert!(msg.is_ok());
        let msg = msg.unwrap();
        assert_eq!(msg.magic, Magic::from(Network::Pepecoin));
