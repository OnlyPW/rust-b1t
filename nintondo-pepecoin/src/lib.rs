...
//! # Rust pepecoin Library
//!
//! This is a library that supports the pepecoin network protocol and associated
//! primitives. It is designed for Rust programs built to work with the pepecoin
//! network.
//!
