...
//! pepecoin addresses.
//!
//! Support for ordinary base58 pepecoin addresses and private keys.
//!
//! # Example: creating a new address from a randomly-generated key pair
//!
//! ```rust
//! # #[cfg(feature = "rand-std")] {
//! use nintondo_pepecoin::{Address, PublicKey, Network};
//! use nintondo_pepecoin::secp256k1::{rand, Secp256k1};
//!
...
/// ```rust
/// use std::str::FromStr;
/// use nintondo_pepecoin::{Address, Network};
/// use nintondo_pepecoin::address::{NetworkUnchecked, NetworkChecked};
///
/// // variant 1
...
/// ```
/// # use std::str::FromStr;
/// # use nintondo_pepecoin::address::{Address, NetworkChecked};
...
/// ```
/// # use std::str::FromStr;
/// # use nintondo_pepecoin::address::{Address, NetworkUnchecked};
/// let address: Address<NetworkUnchecked> = Address::from_str("132F25rTsvBdp9JzLLBHP5mvGY66i1xdiM")
///                .unwrap();
...
impl Address {
    ...
    /// # let address = ADDRESS.parse::<nintondo_pepecoin::Address<_>>().unwrap().assume_checked();
...
impl Address<NetworkUnchecked> {
    ...
    /// ```rust
    /// use nintondo_pepecoin::{Address, Network};
    /// use nintondo_pepecoin::address::NetworkUnchecked;
    ///
...
mod tests {
    ...
    use crate::network::constants::Network::{Pepecoin, Testnet};
    ...
    fn test_p2pkh_from_key() {
        ...
        let addr = Address::p2pkh(&key, Pepecoin);
    ...
    fn test_p2wpkh() {
        ...
        let mut key = "033bc8c83c52df5712229a2f72206d90192366c36428cb0c12b6af98324d97bfbc"
            .parse::<PublicKey>()
            .unwrap();
        let addr = Address::p2wpkh(&key, Pepecoin).unwrap();
        ...
        assert_eq!(Address::p2wpkh(&key, Pepecoin), Err(Error::UncompressedPubkey));
    }
    ...
    fn test_p2wsh() {
        ...
        let addr = Address::p2wsh(&script, Pepecoin);
        assert_eq!(
            &addr.to_string(),
    ...
    fn test_p2shwpkh() {
        ...
        let mut key = "026c468be64d22761c30cd2f12cbc7de255d592d7904b1bab07236897cc4c2e766"
            .parse::<PublicKey>()
            .unwrap();
        let addr = Address::p2shwpkh(&key, Pepecoin).unwrap();
    ...
    fn test_p2shwsh() {
        ...
        let addr = Address::p2shwsh(&script, Pepecoin);
    ...
    fn test_non_existent_segwit_version() {
        ...
        let addr = Address::new(Pepecoin, Payload::WitnessProgram(witness_prog));
        roundtrips(&addr);
    }
