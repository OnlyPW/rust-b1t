...
/// # Examples
/// ```
/// # use nintondo_pepecoin::absolute::{LockTime, LockTime::*};
...
pub enum LockTime {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_pepecoin::absolute::LockTime;
    ///
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use nintondo_pepecoin::absolute::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_pepecoin::locktime::absolute::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_pepecoin::locktime::absolute::Time;
    ///
