...
impl OutPoint {
    ...
    ///
    /// ```rust
    /// use nintondo_pepecoin::constants::genesis_block;
    /// use nintondo_pepecoin::network::constants::Network;
    ///
    /// let block = genesis_block(Network::Pepecoin);
...
impl<E> EncodeSigningDataResult<E> {
    ...
    ///
    /// ```rust
    /// # use nintondo_pepecoin::consensus::deserialize;
    /// # use nintondo_pepecoin::sighash::{LegacySighash, SighashCache};
    /// # use nintondo_pepecoin::Transaction;
    /// # use bitcoin_hashes::{Hash, hex::FromHex};
    /// # let mut writer = LegacySighash::engine();
    /// # let input_index = 0;
    /// # let script_pubkey = nintondo_pepecoin::ScriptBuf::new();
...
mod tests {
    ...
    fn test_is_coinbase() {
        ...
        let genesis = constants::genesis_block(Network::Pepecoin);
    ...
    fn test_transaction_verify() {
        ...
        match spending
            ...
            .unwrap()
        {
            script::Error::PepecoinConsensus(_) => {}
